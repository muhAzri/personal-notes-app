...
export default function Layout(): JSX.Element {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-slate-900 text-gray-900 dark:text-gray-100 font-inter transition-colors">
      <header className="bg-white dark:bg-slate-800 shadow-sm border-b border-gray-200 dark:border-slate-700">
        <div className="max-w-6xl mx-auto px-3 sm:px-6 py-3 sm:py-4">
          <nav className="flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-0">
            <TypographyH1 className="text-lg sm:text-2xl text-gray-900 dark:text-gray-100">📝 Notes App</TypographyH1>
